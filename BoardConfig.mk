...
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 23091200 # This is the maximum known partition size, but it can be higher, so we just omit it
...
TARGET_KERNEL_SOURCE := kernel/ktouch/i9
TARGET_KERNEL_CONFIG := i9_defconfig
